    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mViewWidth == 0 || mViewHeight == 0) {
            ...
            if (mViewWidth > 0 || mViewHeight > 0) {
                ...
                mLinearGradient = new LinearGradient(-mViewWidth, -mViewHeight, mViewWidth, mViewHeight,
                        new int[]{0xf85d00, 0xffffffff, 0xf85d00},
...
//            int temp = (int) Math.sqrt(mTranslateX*mTranslateX+mTranslateY*mTranslateY);
